    ...
    <div className="min-h-screen bg-black text-zinc-200 relative overflow-hidden flex flex-col items-center justify-center perspective-[1000px]">
      ...
      <div className="relative z-10 text-center flex flex-col items-center" style={{ transformStyle: 'preserve-3d' }}>
        ...
        >
          <DrippingText 
            text="NIGHT HAS COME" 
            className="text-5xl md:text-7xl lg:text-8xl font-['var(--font-nosifer)'] font-black tracking-[0.1em] text-red-600 drop-shadow-[0_0_15px_rgba(220,38,38,0.9)] drop-shadow-[0_0_30px_rgba(220,38,38,0.7)]"
          />
        </motion.div>
        ...
        <motion.p 
          ...
          className="text-xl md:text-3xl font-bold text-zinc-300 tracking-widest mb-8 px-6 py-3 rounded-xl bg-white/5 backdrop-blur-md border border-white/10 shadow-lg drop-shadow-[0_0_5px_rgba(220,38,38,0.5)]"
        >
