    ...
    <div className="min-h-screen bg-black text-zinc-200 relative overflow-hidden flex flex-col items-center justify-center perspective-[1000px]">
      ...
      <div className="relative z-10 text-center flex flex-col items-center" style={{ transformStyle: 'preserve-3d' }}>
        ...
        <motion.p 
          ...
          className="text-xl md:text-xl sm:text-lg font-bold text-zinc-300 tracking-widest mb-8 sm:mb-4 px-6 py-3 sm:px-4 sm:py-2 rounded-xl sm:rounded-lg bg-white/5 backdrop-blur-md border border-white/10 shadow-lg drop-shadow-[0_0_5px_rgba(220,38,38,0.5)] hover:bg-white/10 transition-colors">Trust no one. Survive the night.
        </motion.p>
        ...
        <motion.button
          ...
          className="px-12 py-6 rounded-[25px] border-2 border-red-600 bg-red-900/30 backdrop-blur-sm flex items-center justify-center text-xl tracking-widest hover:bg-red-800/50 transition-all text-red-100 shadow-[0_0_20px_rgba(220,38,38,0.4)] sm:px-6 sm:py-3 sm:text-lg sm:tracking-normal">▶ PLAY
        </motion.button>
        ...
        <motion.p
          ...
          className="mt-12 text-red-400 text-sm tracking-widest uppercase font-bold drop-shadow-[0_0_10px_rgba(220,38,38,0.8)] sm:text-xs sm:mt-6 sm:tracking-normal" style={{ textShadow: '0 0 10px rgba(220,38,38,0.8), 0 0 20px rgba(220,38,38,0.6)' }}>Created by Zahid Arman
        </motion.p>
