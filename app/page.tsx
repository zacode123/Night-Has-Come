                ...
                <div className="flex flex-col items-start">
                  ...
                  <div className="relative w-24 h-24 self-center">
                   ...
                   <label
                     ...
                     className="w-24 h-24 rounded-full overflow-hidden border-2 border-red-500 cursor-pointer flex items-center justify-center bg-red-950/30"
                   >{avatar ? (
                   ...
                   <label
                     htmlFor="avatarUpload"
                     className="absolute bottom-0 left-0 w-7 h-7 bg-red-500 rounded-full flex items-center justify-center border-2 border-black cursor-pointer"
                   >
