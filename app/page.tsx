                    ...
                    {personalities.map(p => (
                      <div 
                        ...
                        className={`cursor-pointer p-3 rounded-lg transition-all backdrop-blur-md border ${
                          personality === p.id 
                          ? 'bg-red-600/50 border-red-400/40 shadow-[0_0_20px_rgba(220,38,38,0.25)] scale-[1.02]' 
                          : 'bg-white/5 border-white/10 hover:bg-white/10 hover:border-white/20'
                       }`}
                      >
                        <div className="text-red-300 font-medium mb-1">{p.id}</div>
                        <div className="text-red-800/70 text-xs">{p.desc}</div>
                      </div>
                    ))}
                  </div>
                </div>
