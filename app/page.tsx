        ...
        {showSignUpModal && (
          ...
          >
            <motion.div 
              ...
              className="bg-white/10 backdrop-blur-xl border border-white/20 shadow-[0_8px_32px_rgba(0,0,0,0.3)] p-8 rounded-2xl w-full max-w-2xl scale-95 sm:scale-100 max-h-[90vh] overflow-y-auto"
              ...
              <form onSubmit={handleSignUp} className="space-y-6">
                ...
                <div className="flex flex-col items-start">
                  <label className="text-sm text-red-400 mb-3 uppercase tracking-wider flex justify-between items-center w-full">Profile Picture
                    ...
                    Maximum profile picture size is 2MB.</span>
                  </label>        
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="relative">
                    ...
                    <button 
                      ...
                      className="absolute right-3 top-[calc(50%-2px)] -translate-y-1/2 text-red-400 hover:text-red-200"
                    >
                      {showSignUpPassword ? (
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M607.5-372.5Q660-425 660-500t-52.5-127.5Q555-680 480-680t-127.5 52.5Q300-575 300-500t52.5 127.5Q405-320 480-320t127.5-52.5Zm-204-51Q372-455 372-500t31.5-76.5Q435-608 480-608t76.5 31.5Q588-545 588-500t-31.5 76.5Q525-392 480-392t-76.5-31.5ZM214-281.5Q94-363 40-500q54-137 174-218.5T480-800q146 0 266 81.5T920-500q-54 137-174 218.5T480-200q-146 0-266-81.5ZM480-500Zm207.5 160.5Q782-399 832-500q-50-101-144.5-160.5T480-720q-113 0-207.5 59.5T128-500q50 101 144.5 160.5T480-280q113 0 207.5-59.5Z"/></svg>
                      )}
                    </button>
                  </div>
                    ...
                    {personalities.map(p => (
                      <div 
                        ...
                        className={`cursor-pointer p-3 rounded-lg transition-all backdrop-blur-md border ${
                          personality === p.id ? 'bg-red-100 border-red-500 shadow-[0_0_20px_rgba(220,38,38,0.35)] scale-[1.02]' : 'bg-zinc-200/90 border-zinc-300 hover:bg-zinc-100'
                       }`}
                      >
                        <div className={`font-semibold mb-1 ${personality === p.id ? 'text-red-700' : 'text-zinc-900'}`}>{p.id}</div>
                        <div className={`text-xs font-medium ${personality === p.id ? 'text-red-950/80' : 'text-zinc-600'}`}>{p.desc}</div>
                      </div>
                    ))}
                  </div>
                </div>
        ...
        {showSignInModal && (
          ...
          >
            <motion.div
              ...
              animate={{ scale: 1 }}
              exit={{ scale: 0.9 }}
              className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.3)] p-8 w-full max-w-sm sm:max-w-md"
            >
              <button
                onClick={() => {
                  audioEngine.playClick();
